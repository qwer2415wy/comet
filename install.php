...
if (version_compare(phpversion(), '7.0.0', '<')) {
    die('PHP version ' . phpversion() . ' is not supported. Please consider upgrading to PHP 7 or newer.');
}
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === 'true') {
                        ...
                        document.getElementById("title").innerHTML = "Plugin not installed or configured";
                        document.getElementById("header").style.cssText = 'background-color:red !important';
