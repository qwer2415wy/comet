	...
	switch(locale){
		...
		case "zh_CN": //Credit to Neubulae
			lang = {
				...
				"home_description": "請使用選單添加新的伺服器, 或連接至已設定伺服器.",
				...
				"addServerModalSvIp": "伺服器IP地址:",
				"addServerModalSvPort": "Port:",
				"addServerModalSvSsl": "伺服器已開啟SSL",
				...
				"disconnectionModalDescription": "與伺服器的連線中斷, 可能是因為伺服器停止運行.",
				"disconnectionModalCloseButton": "關閉",
				"disconnectionModalWelcomeScreenButton": "返回歡迎頁面",
				"settingsLink": "設定",
				"settingsModalLongTitle": "設定",
				"showDateSettingsSwitchLabel": "在每個控制台上顯示時間",
				"readLogFileSwitchLabel": "登錄後從伺服器檢視完整的紀錄",
