...
function setLanguage(locale){
	...
	switch(locale){
		...
		case "zh_CN": //Credit to Neubulae
			lang = {
				"navbarHomeLink": "首頁",
				"home_header": "請從菜單中選擇一個服務器",
				"home_description": "請使用導航欄以添加新服務器, 或連接至已設定服務器.",
				"serversDropdown": "你的服務器",
				"add_server": "添加服務器",
				"noServersAdded": "沒有添加服務器",
				"lang_dropdown": "語言",
				"addServerModalLongTitle": "添加一個新服務器",
				"addServerModalSvName": "服務器名稱:",
				"addServerModalSvIp": "服務器IP地址:",
				"addServerModalSvPort": "WebConsole端口:",
				"addServerModalSvSsl": "服務器已開啟SSL",
				...
				"disconnectionModalLongTitle": "已斷開",
				"disconnectionModalDescription": "與服務器的通信中斷, 可能是因為服務器停止運行.",
				"disconnectionModalCloseButton": "關閉",
				"disconnectionModalWelcomeScreenButton": "返回歡迎頁面",
				"settingsLink": "設定值",
				"settingsModalLongTitle": "WebConsole 設定值",
				"showDateSettingsSwitchLabel": "在每個控制台行上顯示時間",
				"readLogFileSwitchLabel": "登錄後從服務器檢索完整的日志文件",
				"settingsModalCloseButton": "完成",
				"players_online": "在線人數",
				"cpu_title": "CPU",
				"ram_title": "內存使用量",
				"user_title": "登錄為",
				"deleteServerButton": "關閉服務器",
