...
<head>
    ...
    <!--<script src="//cdnjs.cloudflare.com/ajax/libs/tinymce/4.8.3/tinymce.min.js"></script>
                    ...
                    <div class="tooltip">
                        ...
                        <a class="nm-nav-item nm-button" style="display: inherit !important; min-width: 0 !important;"
                           aria-label="tasks" name="Tasks">
                            <i style="color: white;" class="material-icons">work</i>
                        </a>
                    </div>
                </div>
                <div class="nm-appbar-more-actions-menu">
                    <div class="tooltip">
                        ...
                        <a class="nm-nav-item nm-button" style="display: inherit !important; min-width: 0 !important;"
                           aria-label="account" name="Account Settings" disabled>
        ...
        <nm-navbar>
            <div class="nm-nav">
                ...
                if (hasPermission('view_players') || hasPermission('view_tickets') || hasPermission('view_punishments') || hasPermission('view_chatlogs') || hasPermission('view_chat') || hasPermission("view_helpop") || hasPermission('view_reports')) {
                    ...
                    if (hasPermission('view_chatlogs') && isModuleEnabled('command_chatlog_enabled')) {
                ...
                if (hasPermission('view_network') || hasPermission('view_languages') || hasPermission('view_filter') || hasPermission("view_permissions") || hasPermission('view_pre_punishments') || hasPermission("view_commandblocker") || hasPermission("view_tabcompletecommands") || hasPermission('view_announcements')) {
                    echo '<div class="nm-nav-group">
                    <div class="nm-nav-heading">' . $lang['TITLE_NETWORK'] . '</div>';
                    if (hasPermission('view_network')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="settings" name="' . $lang['TITLE_NETWORKSETTINGS'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    <nm-navbar-item><a class="nm-nav-item" aria-label="motd" name="' . $lang['TITLE_MOTDANDMAINTENANCE'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission('view_pre_punishments') && isModuleEnabled('module_pre_punishments')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="prepunishments" name="Punishment Templates">
                            <div class="nm-nav-item-lockup">
                                <i class="nm-nav-icon nm-icons material-icons">gavel</i>
                                <span class="nm-entry-displayname">Punishment Templates</span>
                            </div>
                        </a>
                    </nm-navbar-item>';
                    }
                    if (hasPermission('view_servers') && isModuleEnabled('module_servermanager')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="servers" name="' . $lang['TITLE_SERVERS'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission('view_tags') && isModuleEnabled('module_tags')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="tags" name="' . $lang['TITLE_TAGS'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission('view_filter') && isModuleEnabled('module_filter')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="filter" name="' . $lang['TITLE_FILTER'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission('view_commandblocker') && isModuleEnabled('module_commandblocker')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="commandblocker" name="' . $lang['TITLE_COMMANDBLOCKER'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission('view_announcements') && isModuleEnabled('module_announcements')) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="announcements" name="' . $lang['TITLE_ANNOUNCEMENTS'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    if (hasPermission("view_tabcompletecommands")) {
                        echo '<nm-navbar-item><a class="nm-nav-item" aria-label="tabcompletecommands" name="' . $lang['TITLE_TABCOMPLETECOMMANDS'] . '">
                            <div class="nm-nav-item-lockup">
                ...
                if (hasPermission('view_accounts')) {
                    ...
                    <nm-navbar-item><a class="nm-nav-item" aria-label="accounts" name="' . $lang['TITLE_GROUPSANDACCOUNTS'] . '">
                            <div class="nm-nav-item-lockup">
                ...
                if (hasPermission('view_addons')) {
                    ...
                    */
                    ...
                    foreach (scandir("../addons") as $file) {
                        if ('.' === $file) continue;
                        if ('..' === $file) continue;
                        echo '<nm-navbar-item><a class="nm-nav-item" addon="' . $file . '" aria-label="' . $file . '" name="' . $file . '">
                            <div class="nm-nav-item-lockup">
                ...
                echo '<div class="nm-nav-group">
                    ...
                    <nm-navbar-item><a class="nm-nav-item" aria-label="tasks" name="' . $lang['TITLE_TASKS'] . '">
                            <div class="nm-nav-item-lockup">
                    ...
                    <nm-navbar-item><a class="nm-nav-item" aria-label="account" name="' . $lang['TITLE_ACCOUNTSETTINGS'] . '">
                            <div class="nm-nav-item-lockup">
                                <i class="nm-nav-icon nm-icons material-icons">settings</i>
