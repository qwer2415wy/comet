                                ...
                                <td>
                                    ...
                                    <td>
                                        <div class="fb-table-cell-wrapper text-right">
                                            <button style="background: transparent; border: none" edit-group="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
                                            <button style="background: transparent; border: none" delete-group="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
                                        </div>
                                    </td>
                            </tr>';
    }
