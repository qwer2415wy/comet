...
if ($type == 'groups') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            echo '<tr>
                                ...
                                <td>
                                    <div class="fb-table-cell-wrapper">
                                        <span><a nmgroupid1="' . $row['id'] . '" nmgroupname1="' . $row['name'] . '">' . $row['name'] . '</a></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="fb-table-cell-wrapper">
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     ...
                                     <!--<button class="nm-button nm-raised nm-raised-edit" nmedit-group="' . $row['id'] . '" style="position: relative;right: -24px;">' . $lang['VAR_EDIT'] . '</button>-->
                                        <button style="background: transparent; border: none" nmedit-group="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
                                        <button style="background: transparent; border: none" nmdelete-group="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
                                     </div>
                                </td>';
            }
            echo '</tr>';
    ...
    $stmt->execute();
    echo '<div class="data-card-button-box"><a href="#' . $groupid . '" nmgroupmembers="' . $groupid . '" style="bottom: 2px" class="nm-button nm-raised">' . $lang['PERMISSIONS_GROUP_MEMBER_LIST'] . '</a><a href="#' . $groupid . '" nmgroupprefixes="' . $groupid . '" style="bottom: 2px" class="nm-button nm-raised">Prefixes</a><a href="#' . $groupid . '" nmgroupsuffixes="' . $groupid . '" style="bottom: 2px" class="nm-button nm-raised">Suffixes</a><a href="#' . $groupid . '" nmgroupparents="' . $groupid . '" style="bottom: 2px" class="nm-button nm-raised">Parents</a></div>';
    if ($stmt->rowCount() > 0) {
        $stmt->setFetchMode(PDO::FETCH_ASSOC);
        $iterator = new IteratorIterator($stmt);
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                            <button style="background: transparent; border: none" groupid="' . $groupid . '" nmedit-group-permission="' . $row['id'] . '"  style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
                                            <button style="background: transparent; border: none" groupid="' . $groupid . '" nmdelete-group-permission="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" nmdelete-groupparent="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" groupid="' . $groupid . '" nmedit-group-prefix="' . $row['id'] . '"  style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
                                        <button style="background: transparent; border: none" groupid="' . $groupid . '" nmdelete-group-prefix="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" groupid="' . $groupid . '" nmedit-group-suffix="' . $row['id'] . '"  style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
                                        <button style="background: transparent; border: none" groupid="' . $groupid . '" nmdelete-group-suffix="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    $start = $offset + 1;
    $end = min(($offset + $limit), $total);
    $prevlink = ($page > 1) ? '<a groupid="' . $groupid . '" nmgroupmembersPage="' . ($page - 1) . '" class="nm-pagination-icon"  page="' . ($page - 1) . '"><i class="material-icons">keyboard_arrow_left</i></a>' : '';
    $nextlink = ($page < $pages) ? '<a groupid="' . $groupid . '" nmgroupmembersPage="' . ($page - 1) . '" class="nm-pagination-icon" page="' . ($page + 1) . '"><i class="material-icons">keyboard_arrow_right</i></a>' : '';
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" groupid="' . $groupid . '" nmdelete-group-member="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" nmedit-permplayer="' . $row['uuid'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: orange">create</i></button>
    ...
    $stmt->bindParam(3, $offset, 1);
    $stmt->execute();
    echo '<div class="data-card-button-box"><a nmusergroups="' . $uuid . '" style="bottom: 2px" class="nm-button nm-raised">Groups</a></div>';
    if ($stmt->rowCount() > 0) {
        $stmt->setFetchMode(PDO::FETCH_ASSOC);
        $iterator = new IteratorIterator($stmt);
        ...
        foreach ($iterator as $row) {
            ...
            echo '<tr>
                                ...
                                <td>
                                    <div class="fb-table-cell-wrapper">
                                        <div class="nm-input-container" style="position: relative; top: 0; padding: 0 !important;">
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" nmuseruuid="' . $row['playeruuid'] . '" nmdelete-player-permission="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
    ...
    $uuid = $_GET['uuid'];
    $total = $pdo->prepare('SELECT COUNT(*) FROM nm_permissions_playergroups WHERE `playeruuid`=?;');
    $total->bindParam(1, $uuid, 2);
    $total->execute();
    $total = $total->fetchColumn();
    $limit = 10;
    ...
    $start = $offset + 1;
    $end = min(($offset + $limit), $total);
    $prevlink = ($page > 1) ? '<a nmusergroupspage="' . ($page - 1) . '" useruuid="' . $uuid . '" class="nm-pagination-icon"  page="' . ($page - 1) . '"><i class="material-icons">keyboard_arrow_left</i></a>' : '';
    $nextlink = ($page < $pages) ? '<a nmusergroupspage="' . ($page - 1) . '" useruuid="' . $uuid . '" class="nm-pagination-icon" page="' . ($page + 1) . '"><i class="material-icons">keyboard_arrow_right</i></a>' : '';
    $stmt = $pdo->prepare('SELECT `id`, `playeruuid`, `groupid`, `server`, `expires` FROM nm_permissions_playergroups WHERE `playeruuid`=? ORDER BY `id` DESC LIMIT ? OFFSET ?;');
    $stmt->bindParam(1, $uuid, 2);
    $stmt->bindParam(2, $limit, 1);
    $stmt->bindParam(3, $offset, 1);
    $stmt->execute();
    if ($stmt->rowCount() > 0) {
        ...
        foreach ($iterator as $row) {
            ...
            echo '<tr>
                                ...
                                <td>
                                    <div class="fb-table-cell-wrapper">
                                        <span>' . getGroupNameByID($row['groupid']) . '</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="fb-table-cell-wrapper">
            ...
            if (hasPermission('edit_permissions')) {
                echo '<td class="text-right">
                                     <div class="fb-table-cell-wrapper">
                                        <button style="background: transparent; border: none" groupid="' . $row['groupid'] . '" nmdelete-group-member="' . $row['id'] . '" style="position: relative;right: -24px;"><i class="material-icons" style="color: red">delete</i></button>
                                        <!--<button class="nm-button nm-raised nm-raised-delete" nmuseruuid="' . $row['playeruuid'] . '" nmdelete-player-permission="' . $row['id'] . '" style="position: relative;right: -24px;">' . $lang['VAR_DELETE'] . '</button>-->
                                     </div>
                                </td>';
            }
    ...
    $ladder = $purifier->purify($_GET['ladder']);
    $rank = $purifier->purify($_GET['rank']);
    ...
    try {
        ...
        if ($stmnt->rowCount() == 0) {
            ...
            $stmnt->bindParam(1, $name, PDO::PARAM_STR);
            $stmnt->bindParam(2, $ladder, PDO::PARAM_STR);
    ...
    $groupid = $_GET['groupid'];
    $permission = trim(preg_replace('/\s+/', '', $purifier->purify($_GET['permission'])));
    $server = $purifier->purify($_GET['server']);
    $world = $purifier->purify($_GET['world']);
    ...
    $groupid = $purifier->purify($_GET['groupid']);
    $username = $purifier->purify($_GET['username']);
    $server = $purifier->purify($_GET['server']);

    $uuid = getUuid($username);

    $stmnt = $pdo->prepare('SELECT `playeruuid` FROM nm_permissions_playergroups WHERE `groupid`=? AND `playeruuid`=?;');
    ...
    $groupid = filter_input(INPUT_GET, 'groupid', FILTER_SANITIZE_STRING);
    $prefix = html_entity_decode($purifier->purify($_GET['prefix']));
    $server = $purifier->purify($_GET['server']);

    $stmnt = $pdo->prepare('SELECT 1 FROM nm_permissions_groupprefixes WHERE `groupid`=? AND `prefix`=?;');
    $stmnt->bindParam(1, $groupid, 2);
    ...
    $groupid = filter_input(INPUT_GET, 'groupid', FILTER_SANITIZE_STRING);
    $suffix = html_entity_decode($purifier->purify($_GET['suffix']));
    $server = $purifier->purify($_GET['server']);

    $stmnt = $pdo->prepare('SELECT 1 FROM nm_permissions_groupsuffixes WHERE `groupid`=? AND `suffix`=?;');
    $stmnt->bindParam(1, $groupid, 1);
    ...
    $uuid = filter_input(INPUT_GET, 'useruuid', FILTER_SANITIZE_STRING);
    $permission = trim(preg_replace('/\s+/', '', $purifier->purify($_GET['permission'])));
    $server = $purifier->purify($_GET['server']);
    $world = $purifier->purify($_GET['world']);
    $expires = $_GET['expires'] != "" ? strftime('%Y-%m-%d %H:%M:%S', strtotime($_GET['expires'])) : NULL;
    ...
    echo '<div id="add-group-permission" class="modal" group="' . $id . '">
            ...
            <h3 style="font-size: 15px;font-weight: 200">Add permission to group: ' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="add-group-member" class="modal" group="' . $id . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Add member to group: ' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="add-group-parent" class="modal" group="' . $id . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Add parent to group ' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="add-group-prefix" class="modal" group="' . $id . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Add prefix to group: ' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="add-group-suffix" class="modal" group="' . $id . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Add suffix to group: ' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="nmedit-group" class="modal" group="' . $id . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Edit group with ID:' . getGroupNameByID($id) . '</h3>
    ...
    echo '<div id="add-user-permission" class="modal" useruuid="' . $useruuid . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Add permission to user ' . getName($useruuid) . '</h3>
    ...
    echo '<div id="nmedit-permplayer" class="modal" useruuid="' . $useruuid . '">
            <div class="modal-content" style="width: 600px !important;">
            <h3 style="font-size: 15px;font-weight: 200">Editing user: ' . getName($useruuid) . ' (' . $useruuid . ')</h3>
