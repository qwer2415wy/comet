...
if (!isset($_GET['type'])) {
    ...
    <div class="col-12">
        <div class="data-card">
            ...
            <div class="data-card-body" style="padding: 3px;">
        ...
        $stmnt1->bindParam(1, $id, PDO::PARAM_INT);
        $stmnt1->execute();
    ...
    $id = $_GET['id'];
    $message = $purifier->purify(urldecode($_GET['message']));
    $time = round(microtime(true) * 1000);
    ...
    //echo 'Responded to ticket ' . $id . ' by ' . $user . ' message ' . $message;
