                        ...
                        <div class="data-card-search-box">
                            ...
                            <form id="filter">
                                <input type="text" id="search-input" class="data-card-input"
                                       placeholder="<?php echo $lang['FILTER_ADDWORD'] ?>" autocomplete="off">
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    if (typeof isFilterLoaded === 'undefined') {
        $.getScript("../inc/js/pages/filter.js", function (data, textStatus, jqxhr) {
