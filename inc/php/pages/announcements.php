    ...
    <div class="modal-content" style="width: 600px !important;">
        <form id="create-announcement-form">
            <div class="nm-input-container">
                ...
                <label>
                    <select name="atype" id="announcement-type" required>
                        ...
                        <option value="2">chat servers only</option>
            ...
            <div class="nm-input-container">
                ...
                <label>
                    <textarea rows="5" form="create-announcement-form" name="message" id="messageinput"></textarea>
                </label>
            </div>
            <div class="nm-input-container" id="sound">
                <label>Sound</label>
                <label>
                    <input type="text" name="sound" id="soundinput">
                </label>
            </div>
