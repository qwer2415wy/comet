...
<div id="create-punishment" class="modal">
    <div class="modal-content" style="width: 600px !important;">
        <form id="create-punishment-form">
            ...
            <div class="nm-input-container" style="position: relative; top: -10px; right: 16px; padding: 0 !important;">
                <input type="checkbox" id="silent" name="silent" class="switch-input">
                <label for="silent" class="switch-label"><span style="position: relative !important; top: -4px !important;" class="toggle--on">Silent</span><span style="position: relative !important; top: -4px !important;" class="toggle--off">Silent</span></label>
            </div>
