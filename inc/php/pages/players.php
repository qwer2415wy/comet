                        ...
                        <div class="data-card-search-box">
                            ...
                            <form>
                                <input type="text" id="search-input" class="data-card-input"
                                       placeholder="<?php echo $lang['PLAYER_SEARCH']; ?>" autocomplete="off">
                            </form>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $("#data-card-content").load('../inc/php/dep/pages/players.php?p=1', function () {
            console.log('loaded');
        });
    });
    ...
    $("input#search-input").keyup(function () {
        $("#data-card-content").load('../inc/php/dep/pages/playersearch.php?q=' + this.value + "&p=1", function () {
    ...
    $(document).on('click', 'a', function () {
        if (this.hasAttribute('players')) {
            let attr = $(this).attr('page');
            if (typeof attr !== typeof undefined && attr !== false) {
                $("#data-card-content").load('../inc/php/dep/pages/players.php?p=' + attr, function () {
                    console.log('player load performed');
                });
            }
        } else if (this.hasAttribute('playersearch')) {
            let attr = $(this).attr('page');
            let query = $(this).attr('query');
            if (typeof attr !== typeof undefined && attr !== false) {
                $("#data-card-content").load('../inc/php/dep/pages/playersearch.php?p=' + attr + '&q=' + query, function () {
                    console.log('player load performed');
                });
            }
        }
