    ...
    <div class="modal-content" style="width: 600px !important;">
        <form id="create-group-form">
            ...
            <div class="nm-input-container">
                <label>Ladder *</label>
                <label>
                    <input type="text" name="ladder" value="default" required>
                </label>
            </div>
            <div class="nm-input-container">
                <label>Rank *</label>
                <label>
                    <input type="number" name="rank" value="100" min="1" required>
                </label>
            </div>
...
<script>
    ...
    $("input#search-users-input").keyup(function () {
        let value = this.value
            .replace('[', ';v5')
            .replace(']', ';v6');
        $("#data-users-content").load('../inc/php/dep/pages/permissionssearch.php?load=users&p=1&q=' + value, function () {
            console.log('load performed');
        });
        if ($(this).val().length === 0) {
            console.log($(this).val().length);
