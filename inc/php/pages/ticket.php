...
<script>
    ...
    $(document).ready(function() {
        $.loadScript('//cdnjs.cloudflare.com/ajax/libs/tinymce/4.7.13/tinymce.min.js', function() {
            var id = <?php echo $_GET['id']; ?>;

            $("#data-card-content").load('../inc/php/dep/pages/ticket.php?id=' + id, function (data) {
                console.log('loaded');
            });
        });
    });
