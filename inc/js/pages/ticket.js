...
$(document.body).on('click', 'button', function () {
    if (this.id === 'ticket-respond') {
        ...
        $.get("../inc/php/dep/pages/ticket.php?type=respond_ticket&id=" + id + "&message=" + encodedMessage, function (data) {
            console.log(data);
            $("#cached-message").append('<div id="ticket-' + id + '" class="col-12"><div class="data-card"> <div class="data-card-header"> <div class="data-card-header-title" id="ticket-title">You <small> a moment ago</small></div></div><div class="data-card-body" style="padding: 3px;"><div class="ticket-container">' + message + '</div></div></div></div>');
        });
