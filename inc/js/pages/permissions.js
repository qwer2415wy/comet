...
$(document).on('click', 'a', function () {
    ...
    } else if (this.hasAttribute('nmusergroupspage')) {
        let attr = $(this).attr('page');
        let uuid = $(this).attr('useruuid');
        if (typeof attr !== typeof undefined && attr !== false) {
            $("#data-users-content").load('../inc/php/dep/pages/permissions.php?load=usergroups&p=' + attr + '&uuid=' + uuid, function () {
                console.log('user groups load performed');
            });
        }
    ...
    } else if (this.hasAttribute('nmgroupmembersPage')) {
        if (this.hasAttribute('groupid')) {
            let attr = $(this).attr('page');
            let id = $(this).attr('groupid');
            if (typeof attr !== typeof undefined && attr !== false) {
                $("#data-groups-content").load('../inc/php/dep/pages/permissions.php?load=groupmembers&p=' + attr, 'groupid=' + id, function () {
                    console.log('groupmembers load performed page');
                });
            }
        }
    }
...
$(document).on('click', 'a', function (e) {
    if (this.hasAttribute('nmgroupid1')) {
        let attr = $(this).attr('nmgroupid1');
        let name = $(this).attr('nmgroupname1');
        console.log(attr);
        documentid.innerHTML = "Permissions - " + name;
        ...
        let attr = $(this).attr('nmgroupmembers');
        ...
        let attr = $(this).attr('nmgroupprefixes');
        ...
        let attr = $(this).attr('nmgroupsuffixes');
        ...
        let attr = $(this).attr('nmgroupparents');
        ...
        let attr = $(this).attr('userpermissions');
    ...
    } else if (this.hasAttribute('nmusergroups')) {
        let attr = $(this).attr('nmusergroups');
        $("#data-users-content").load('../inc/php/dep/pages/permissions.php?load=usergroups&p=1&uuid=' + attr, function (data) {
            console.log('usergroups load performed');
        })
    } else if (this.hasAttribute('nmbackgroups')) {
        documentid.innerHTML = "Permissions";
        ...
        let attr = $(this).attr('nmbackgroupperms');
...
$(document.body).on('submit', 'form', function (e) {
    ...
    if (this.id === 'create-group-form') {
        ...
        console.log(data);
        $.get("../inc/php/dep/pages/permissions.php?load=create_group&" + data, function (response) {
            if (data.startsWith('false')) {
                swal({
                    title: "Error",
                    text: "Failed to insert group into database!\n" + data.replace('false ', ''),
                    type: "warning",
                    closeOnConfirm: true
                });
            }
        ...
        let data = $(this).serialize();
        let gid = this.getAttribute('group');
        ...
        let gid = this.getAttribute('group');
        console.log(data);
        $.get("../inc/php/dep/pages/permissions.php?load=add_groupperm&groupid=" + gid + "&" + data, function (data) {
            $("#data-groups-content").load('../inc/php/dep/pages/permissions.php?load=grouppermissions&p=1&groupid=' + gid, function () {
            });
        });
        ...
        var gid = this.getAttribute('group');
        console.log(data);
        $.get("../inc/php/dep/pages/permissions.php?load=add_groupprefix&groupid=" + gid + "&" + data, function (data) {
            $("#data-groups-content").load('../inc/php/dep/pages/permissions.php?load=groupprefixes&p=1&groupid=' + gid, function () {
            });
        });
        ...
        var gid = this.getAttribute('group');
        console.log(data);
        $.get("../inc/php/dep/pages/permissions.php?load=add_groupsuffix&groupid=" + gid + "&" + data, function (data) {
            console.log(data);
            $("#data-groups-content").load('../inc/php/dep/pages/permissions.php?load=groupsuffixes&p=1&groupid=' + gid, function () {
            });
        });
        ...
        var gid = this.getAttribute('group');
        console.log(data);
        $.get("../inc/php/dep/pages/permissions.php?load=add_groupmember&groupid=" + gid + '&' + data, function (data) {
            $("#data-groups-content").load('../inc/php/dep/pages/permissions.php?load=groupmembers&p=1&groupid=' + gid, function () {
            });
        });
