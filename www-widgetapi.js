...
return e}
t("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/Array.prototype.keys",function(a){return a?a:function(){return Ga(this,function(b){return b})}});
t("Array.prototype.values",function(a){return a?a:function(){return Ga(this,function(b,c){return c})}});
t("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}});
...
Hb&&(Gb=Hb?Hb[1]:"");if(Ab){var Ib=Eb();if(null!=Ib&&Ib>parseFloat(Gb)){Fb=String(Ib);break a}}Fb=Gb}var Jb=Fb,Sb;if(B.document&&Ab){var Tb=Eb();Sb=Tb?Tb:parseInt(Jb,10)||void 0}else Sb=void 0;var Ub=Sb;var Vb=J("iPhone")&&!J("iPod")&&!J("iPad")||J("iPod"),Wb=J("iPad");var Xb={},Yb=null;var K=window;function Zb(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||B.$googDebugFname||b}catch(g){e="Not available",c=!0}b=$b(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
function ne(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=P("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),je("ERRORS",b))}
function oe(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=P("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),je("ERRORS",b))}
...
function ig(a){var b=window.location.search,c=L(a),d=jc(a.match(ic)[5]||null);d=(c=c&&(c.endsWith("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/youtube.com")||c.endsWith("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Ae(b),f={};H(fg,function(g){e[g]&&(f[g]=e[g])});
return Be(a,f||{},!1)}
...
function ug(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/www.youtube-nocookie.com"))return d;(b=c.Ca||P("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ba:b=Cc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),T("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
xg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(yd(b))}catch(f){return}else e=escape(b);b=this.g;dc.set(""+a,e,{V:c,path:"/",domain:void 0===b?"http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/youtube.com":b,secure:!1})};
...
xg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;dc.remove(""+a,"/",void 0===b?"http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/youtube.com":b)};var yg;function zg(){yg||(yg=new xg);return yg}
...
Aa;window.yterr&&"function"===typeof window.yterr&&window.yterr(ea);if(!($h.has(ea.message)||0<=ea.stack.indexOf("YouTubeCenter.js"/*tpa=http://s.ytimg.com/YouTubeCenter.js*/)||0<=ea.stack.indexOf("mytube.js"/*tpa=http://s.ytimg.com/mytube.js*/))){Zh.J("handleError",ea);if(T("kevlar_gel_error_routing")){var Ob=void 0,pf=m,N=ea;a:{for(var qf=u(bi),id=qf.next();!id.done;id=qf.next()){var rf=I;if(rf&&0<=rf.toLowerCase().indexOf(id.value.toLowerCase())){var sf=!0;break a}}sf=!1}if(!sf){var ab={stackTrace:N.stack};N.fileName&&(ab.filename=N.fileName);var fa=N.lineNumber&&N.lineNumber.split?
...
;D("YT.PlayerState.UNSTARTED",-1);D("YT.PlayerState.ENDED",0);D("YT.PlayerState.PLAYING",1);D("YT.PlayerState.PAUSED",2);D("YT.PlayerState.BUFFERING",3);D("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/YT.PlayerState.CUED",5);D("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/YT.get",function(a){return Ee[a]});
D("http://s.ytimg.com/yts/jsbin/www-widgetapi-vflOyhzcj/YT.scan",He);D("YT.subscribe",function(a,b,c){Sd.subscribe(a,b,c);Ge[a]=!0;for(var d in Ee)fi(Ee[d],a)});
