...
return e}
t("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/Array.prototype.keys",function(a){return a?a:function(){return Ga(this,function(b){return b})}});
t("Array.prototype.values",function(a){return a?a:function(){return Ga(this,function(b,c){return c})}});
t("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}});
...
Hb&&(Gb=Hb?Hb[1]:"");if(Ab){var Ib=Eb();if(null!=Ib&&Ib>parseFloat(Gb)){Fb=String(Ib);break a}}Fb=Gb}var Jb=Fb,Kb;if(B.document&&Ab){var Tb=Eb();Kb=Tb?Tb:parseInt(Jb,10)||void 0}else Kb=void 0;var Ub=Kb;var Vb=K("iPhone")&&!K("iPod")&&!K("iPad")||K("iPod"),Wb=K("iPad");var Xb={},Yb=null;var L=window;function Zb(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||B.$googDebugFname||b}catch(g){e="Not available",c=!0}b=$b(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
function oe(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=P("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),ke("ERRORS",b))}
function pe(a){var b=C("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=P("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),ke("ERRORS",b))}
...
function kg(a){var b=window.location.search,c=kc(a),d=jc(a.match(ic)[5]||null);d=(c=c&&(c.endsWith("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/youtube.com")||c.endsWith("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Be(b),f={};I(hg,function(g){e[g]&&(f[g]=e[g])});
return Ce(a,f||{},!1)}
...
function wg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/www.youtube-nocookie.com"))return d;(b=c.Ca||P("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ba:b=Dc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),T("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
zg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,D()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(zd(b))}catch(f){return}else e=escape(b);b=this.g;dc.set(""+a,e,{V:c,path:"/",domain:void 0===b?"http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/youtube.com":b,secure:!1})};
...
zg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;dc.remove(""+a,"/",void 0===b?"http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/youtube.com":b)};var Ag;function Bg(){Ag||(Ag=new zg);return Ag}
...
Ba;window.yterr&&"function"===typeof window.yterr&&window.yterr(fa);if(!(bi.has(fa.message)||0<=fa.stack.indexOf("YouTubeCenter.js"/*tpa=http://s.ytimg.com/YouTubeCenter.js*/)||0<=fa.stack.indexOf("mytube.js"/*tpa=http://s.ytimg.com/mytube.js*/))){ai.J("handleError",fa);if(T("kevlar_gel_error_routing")){var Pb=void 0,qf=m,N=fa;a:{for(var rf=u(di),jd=rf.next();!jd.done;jd=rf.next()){var sf=J;if(sf&&0<=sf.toLowerCase().indexOf(jd.value.toLowerCase())){var tf=!0;break a}}tf=!1}if(!tf){var bb={stackTrace:N.stack};N.fileName&&(bb.filename=N.fileName);var ha=N.lineNumber&&N.lineNumber.split?
...
;E("YT.PlayerState.UNSTARTED",-1);E("YT.PlayerState.ENDED",0);E("YT.PlayerState.PLAYING",1);E("YT.PlayerState.PAUSED",2);E("YT.PlayerState.BUFFERING",3);E("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/YT.PlayerState.CUED",5);E("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/YT.get",function(a){return Fe[a]});
E("http://s.ytimg.com/yts/jsbin/www-widgetapi-vfluwQm_X/YT.scan",Ie);E("YT.subscribe",function(a,b,c){Td.subscribe(a,b,c);He[a]=!0;for(var d in Fe)hi(Fe[d],a)});
